...
import type { UserServiceInterface } from "src/modules/user/service/user.service.interface";
import { USER_SERVICE_INTERFACE } from "src/modules/user/service/user.service.interface";
